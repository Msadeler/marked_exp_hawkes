...
class multivariate_exponential_hawkes_censored(object):
    """
    Multivariate Hawkes process with exponential kernel. No events nor initial conditions considered.
    """

    def __init__(self, mu, alpha, beta, censor = 0.2, max_jumps=None, max_time=None):
        """
        ...
        Censoring : positiv float
            Censoring delays after an event in the last component
